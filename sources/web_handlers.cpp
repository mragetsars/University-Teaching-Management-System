...
string login_document(const string &error_message = EMPTYSTRING)
{
    ...
    html += "<p class='muted'>Default manager account: 0 / UT_account</p></form></div><button class='login-theme'>Change Theme</button>";
